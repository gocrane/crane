...
helm repo add prometheus-community-mirror https://finops-helm.pkg.coding.net/gocrane/prometheus-community
helm install prometheus -n crane-system \
                        ...
                        --create-namespace  prometheus-community-mirror/prometheus
echo "Step2: Installing Prometheus finished."

echo "Step3: Installing Grafana "
helm repo add grafana-mirror https://finops-helm.pkg.coding.net/gocrane/grafana
helm install grafana \
             -f https://gitee.com/finops/helm-charts/raw/main/integration/grafana/override_values.yaml \
             -n crane-system \
             --create-namespace grafana-mirror/grafana
